...
[![GitHub license](https://img.shields.io/github/license/zyronon/web-scripts.svg?style=flat-square&color=4285dd&logo=github)](https://github.com/zyronon/web-scripts/)
[![GitHub Star](https://img.shields.io/github/stars/zyronon/web-scripts.svg?style=flat-square&label=Star&color=4285dd&logo=github)](https://github.com/zyronon/web-scripts/)
[![GitHub Fork](https://img.shields.io/github/forks/zyronon/web-scripts.svg?style=flat-square&label=Fork&color=4285dd&logo=github)](https://github.com/zyronon/web-scripts/)
[![](https://img.shields.io/static/v1?label=%20&message=GreasyFork&style=flat-square&labelColor=7B0000&color=960000&logo=data:image/png;base64,)](https://greasyfork.org/zh-CN/users/853311)

🔨 自用的一些好用的油猴脚本，有什么需求、建议、问题直接提 [Issues](https://github.com/zyronon/web-scripts/issues/new/choose)，觉得好用请点个⭐鼓励一下~
...
>
>_[**douyin
** - Vue.js 仿抖音 DouYin imitation TikTok~](https://github.com/zyronon/douyin) <img src="https://img.shields.io/github/stars/zyronon/douyin.svg?style=flat-square&label=Star&color=4285dd&logo=github" height="16px" />_  
> _[**Typing Word
...
要使用任何脚本，首先需要浏览器安装 **Tampermonkey 脚本管理器扩展（[Chrome](https://pan.lanpw.com/b073l8d1e)** / *
